...
<!-- зона заголовка html, тег <title> - строка, которую браузер отображает на вкладках над страницами, <meta> и <link> сообщают технические сведения для браузера, например, что файл имеет кодировку Юникод (utf-8) -->
	...
	<head>
		<title>Личная страница Насти Афанасьевой </title>
	 	<!-- Required meta tags -->
	 	<meta charset="utf-8">
...
<!-- когда будете менять текст, не используйте бюрократических слов типа ГБОУ СОШ, ну пожаалуйста -->
				...
				<div class="col-md-6">
					<article>
						<h3>О себе:</h3>
						<p>Мне 17 лет <br>
						У меня есть две кошки <br>
						Умею играть на скрипке и фортепиано <br>
					    Окончила музыкальную школу <br>
						Любимый фильм - "Унесенные ветром" 1939г <br>
						Любимая муз. группа - Pink Floyd <br>
						Любимый альбом - "The dark side of the moon" <br>
						Любимый режиссер - Уэс Андерсон <br>
						Не разбираюсь в программах, компьютерах и всем, что с ними связано</p>
					</article>
				</div>
...
<!-- тег <ul> - unordered list. Еще бывает тег <ol> -->
					<ul>
					<a href="https://vk.com/theresnodarksideofthemoon"
						<li>VK</li>
					</ul>
				</div>
			</div>
...
<!-- это подвал. В этой части страницы обычно ставят копирайт (с помощью символа &copy;) и пишут об истории создания страницы. Поставьте свой копирайт -->
		<footer class="bs-docs-footer"> 
			<div class="container"> 
				<p style="text-align:right; ">&copy; Н. Афанасьева, 2023</p> 
			</div>
		</footer>
	</body>
</html>
